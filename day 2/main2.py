...
sequence = [1,12,2,3,1,1,2,3,1,3,4,3,1,5,0,3,2,1,9,19,1,13,19,23,2,23,9,27,1,6,27,31,2,10,31,35,1,6,35,39,2,9,39,43,1,5,43,47,2,47,13,51,2,51,10,55,1,55,5,59,1,59,9,63,1,63,9,67,2,6,67,71,1,5,71,75,1,75,6,79,1,6,79,83,1,83,9,87,2,87,10,91,2,91,10,95,1,95,5,99,1,99,13,103,2,103,9,107,1,6,107,111,1,111,5,115,1,115,2,119,1,5,119,0,99,2,0,14,0]
#cachee = order
a =sequence
...
output_desired = 19690720

for i in range(0,100):
    for k in range(0,100):
        sequence = [1,12,2,3,1,1,2,3,1,3,4,3,1,5,0,3,2,1,9,19,1,13,19,23,2,23,9,27,1,6,27,31,2,10,31,35,1,6,35,39,2,9,39,43,1,5,43,47,2,47,13,51,2,51,10,55,1,55,5,59,1,59,9,63,1,63,9,67,2,6,67,71,1,5,71,75,1,75,6,79,1,6,79,83,1,83,9,87,2,87,10,91,2,91,10,95,1,95,5,99,1,99,13,103,2,103,9,107,1,6,107,111,1,111,5,115,1,115,2,119,1,5,119,0,99,2,0,14,0]
        sequence = [1,0,0,3,1,1,2,3,1,3,4,3,1,5,0,3,2,1,9,19,1,13,19,23,2,23,9,27,1,6,27,31,2,10,31,35,1,6,35,39,2,9,39,43,1,5,43,47,2,47,13,51,2,51,10,55,1,55,5,59,1,59,9,63,1,63,9,67,2,6,67,71,1,5,71,75,1,75,6,79,1,6,79,83,1,83,9,87,2,87,10,91,2,91,10,95,1,95,5,99,1,99,13,103,2,103,9,107,1,6,107,111,1,111,5,115,1,115,2,119,1,5,119,0,99,2,0,14,0]
        number = sequence
        print("Working with order = "+str(number[0:10]))
        number[1] = i
        firstGuess = number[1]
        number[2] = k
        secondGuess = number[2]
        blockPrint()
        result = opCode(number)
        enablePrint()
        print(str(firstGuess)+":"+str(secondGuess)+"->"+str(result))
        if result == output_desired:
            print("Success! Sequence for output "+str(output_desired)+" is "+str(result))
            input()
        

# find two integers between 0 and 99 that multiply together to give output_desired
'''
womboCombo = [0, 0]

while womboCombo[0] * womboCombo[1] != output_desired:
    womboCombo[0] += 1
    womboCombo[1] = output_desired/womboCombo[0]
    if womboCombo%output_desired != 0:
        womboCombo[0]
'''